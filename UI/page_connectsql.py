...
class connect_sql(tk.Frame):
    ...
    def init_ui(self):
        ...
        self.hostet.insert(0, DBConfig.DB_HOSTNAME)
        ...
        self.portet.insert(0, DBConfig.DB_PORT)
        ...
        self.usernameet.insert(0, DBConfig.DB_USERNAME)
        ...
        self.passwordet.insert(0, DBConfig.DB_PASSWORD)
        ...
        self.dbet.insert(0, DBConfig.DB_NAME)
    ...
    def connect(self):
        ...
        if rel == True:
            ...
            self.rel.config(text="Connection failed!")
